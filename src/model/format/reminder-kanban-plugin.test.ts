...
describe('KanbanDateTimeFormat', (): void => {
    test("format - no page link", (): void => {
        ...
        expect(sut.format(new DateTime(moment("2021-09-12"), false))).toBe("@{2021-09-12}");
        expect(sut.format(new DateTime(moment("2021-09-12 07:51"), true))).toBe("@{2021-09-12} @@{07:51}");
    });
